...
var PH_PROVINCES = [
  ...
  // ── REGION I – Ilocos Region ──────────────────────────────────────────────
  {
    ...
    desc: "Ilocos Norte occupies the northwestern tip of Luzon, where the La Paz Sand Dunes in Laoag City rise along the South China Sea coast and the Bangui Windmill Complex lines the open northern shore facing the Luzon Strait. The Kapurpurawan Rock Formation in Burgos stands as one of the most striking coastal geological features in the north, while Paoay Lake — a natural barrier lake formed by coastal sand dune progradation during the late Quaternary — shelters freshwater birds and endemic aquatic life year-round. The province's coastline along Pagudpud is a nesting ground for sea turtles, and Saud Beach and Patapat Viaduct offer dramatic encounters with the raw Luzon Strait shoreline. Inland, Ilocos Norte's rivers and wetlands support migratory waterbirds, and the Cordillera foothills harbour resident Cordillera raptors and forest birds.",
