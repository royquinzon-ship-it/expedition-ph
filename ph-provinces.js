...
var PH_PROVINCES = [
  ...
  // ── REGION II – Cagayan Valley ────────────────────────────────────────────
  {
    ...
    desc: "Batanes is the northernmost and smallest province of the Philippines, a remote archipelago of small islands perched between the Luzon Strait and the Pacific, battered by typhoons and sculpted into sweeping green hillscapes unlike anywhere else in the country. The islands' isolation has preserved a unique Ivatan culture famous for its vakul headgear — woven from voyavoy palm leaves — and sturdy stone houses built with limestone and cogon grass to withstand typhoon winds exceeding 200 km/h. The surrounding seas support seasonal runs of flying fish, mahi-mahi (locally called arayu), and skipjack and yellowfin tuna through the Luzon Strait, sustaining traditional Ivatan mataw fishing practices that have regulated the harvest for generations.",
  ...
  },
  {
    ...
    desc: "Apayao is the most remote and least-visited province of the Cordillera, a densely forested upland territory where vast limestone karst formations hide some of the most spectacular cave systems in northern Luzon. Lussok Cave in Luna is the province's crown jewel — a cathedral-like underground river cave carved through ancient limestone by the Lussok River, navigable by bamboo raft through chambers draped with stalactites and flowstone curtains. The Maton River in Pudtol and other forest rivers offer pristine deep-forest water features within old-growth forest, while natural hot springs in Kabugao provide a rare geothermal feature deep within the mountain interior. The Apayao-Abulug River flows through dramatic limestone gorges that remain virtually untouched, supporting endemic freshwater fish, Philippine Crocodile populations, and some of the richest montane bird communities in northern Luzon.",
  ...
  },
  {
    ...
    desc: "Ifugao is the heartland of the famous Banaue Rice Terraces, a 2,000-year-old hydraulic civilisation carved into steep mountain slopes by the Ifugao people, recognised as a UNESCO World Heritage Site and often called the Eighth Wonder of the World. Tappiyah Falls plunges about 70 metres into a crystal-clear pool accessible by a scenic trek through the terraces near Batad village. The Hapao Rice Terraces in Hungduan include a cluster of natural wetlands that host migratory waterbirds and endemic freshwater species. Mount Napulawan, one of the highest peaks in the Cordillera at over 2,600 metres, shelters old-growth mossy forest and is a critical habitat for the Philippine Eagle. The Ibulao River and its tributaries cut through limestone gorges and dense forest, supplying the irrigation channels that keep the terraces alive. The province's cloud forest ridges shelter the Philippine Bush Warbler — a skulking montane endemic restricted to the Cordillera of northern Luzon — and dozens of other endemic Luzon montane birds.",
  ...
  },
  {
    ...
    desc: "Kalinga is a rugged mountain province carved by the Chico River and its tributaries, which have formed dramatic gorges and river terraces through ancient limestone and granite. The Chico River Gorge in Tinglayan is one of the most spectacular river canyons in the Philippines, with sheer cliff walls and rapids that draw kayakers and trekkers. Balbalasang-Balbalan National Park in the northern highlands protects vast tracts of old-growth montane forest, cloud forest, and mossy ridgelines that are home to the Philippine Eagle and the elusive Whiskered Pitta. Several hidden waterfalls and unnamed cascades deep within the park remain largely unexplored. The Pasil River, another major tributary of the Chico, flows through ancestral forests and limestone outcrops rich in cave formations. The Kalinga people are renowned for their Bodong peace pact system and for the intricate batok (tattoo) tradition kept alive by centenarian elder Whang-od Oggay of Buscalan village.",
    fact: "Whang-od Oggay of Buscalan village, Tinglayan, is the last traditional mambabatok (tattoo artist) of the Butbut Kalinga, now over 100 years old, and was nominated for the Gawad sa Manlilikha ng Bayan — the Philippines' highest honour for traditional practitioners of intangible heritage. Balbalasang-Balbalan National Park is one of the least disturbed protected areas in Luzon, with elevations ranging from 700 to over 2,400 metres sheltering some of the Cordillera's most intact watershed forests.",
    img_seed: "kalinga",
